...
function logFile(text) { fs.appendFile(`/home/raspberrypi/jazhdo-backend-logs/main/log_${startTime}.txt`, `[${Date.now()}] ${text}`, (err) => { if (err) { console.log('Error logging:', err)} }); }
